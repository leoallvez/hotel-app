...
import io.github.leoallvez.hotel.repository.sqlite.HotelSqlHelper
...
class HotelProvider : ContentProvider() {
    ...
    override fun getType(uri: Uri): String? {
        ...
        return when (uriType) {
            TYPE_HOTEL_DIR ->
                return "${ContentResolver.CURSOR_DIR_BASE_TYPE}/io.github.leoallvez.hotel"
            TYPE_HOTEL_ITEM ->
                return "${ContentResolver.CURSOR_ITEM_BASE_TYPE}/io.github.leoallvez.hotel"
            else -> null
        }
    }
    ...
    companion object {
        private const val AUTHORITY = "io.github.leoallvez.hotel"
